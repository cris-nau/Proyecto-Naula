...
a persistence unit "gproyectosPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "gproyectos/pom.xml":
...
artifact ("gproyectos.war") is already built. You can build
